    ...
    <div class="row">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="id" name="id" value="Fatou Sow" required/>
                 </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                     <label class="bmd-label-floating">Login</label>
                     <input type="text" class="form-control" id="id" name="id" value="fatou123" required/>
                 </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="email" class="form-control" id="id" name="id" value="fatou@gmail.com" required/>
                  </div>
                </div>
              </div>
              <div class="row">
      ...
      <div class="col-md-4">
        <div class="card card-profile">
          ...
          <div class="card-body">
            <h6 class="card-category text-gray">Numéro: REQ001</h6>
            <h4 class="card-title">Fatou SOW</h4>
