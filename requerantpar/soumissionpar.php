    ...
    <div class="col-md-12">
           ...
           <div class="card-header mbi" style="background-color:#6495ED;"><span style="color:black; font-weight:bold;">Informations sur le requérant</span> </div>
            <div class="particulier">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <label class="bmd-label-floating" style="color:black;">Nom et prénom du bénéficiare</label>
                    <input type="text" class="form-control">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating" style="color:black;">Localité</label>
                      <select class="form-control" name="">
                        <option value=""></option>
      ...
      <!--les questions sectionnées selon le profil particulier-->
           ...
           <div class="tab">
            <div class="card card-header" style="background-color:#6495ED;"><span style="color:black;font-weight:bold;">Informations sur l'activité</span></div>
             <div class="particulier">
               ...
               <div class="row">
                 <div class="col-md-7">
                   <div class="form-group">
                     <label class="bmd-label-floating" style="color:black;">Quel est le secteur d'activités de l'entité pour laquelle vous travaillez ?</label>
              ...
              <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating" style="color:black;">Quelle est la forme juridique de l’entité pour laquelle vous travaillez ? </label>
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating" style="color:black;">De combien avez-vous besoin (en milliers) ?</label>
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating" style="color:black;">Dans quelle fourchette se chiffre votre rémunération mensuelle nette (en milliers)?</label>
                   <select class="form-control" name="">
                     <option value=""></option>
                      <option value="0-50">0-50</option>
                      <option value="50-200">50-200</option>
             ...
             <div class="row">
               <div class="col-md-3">
                 <p style="color:black;"> Avez-vous d’autres sources de revenus ?<sup style="color:red; font-weight:bold;">*</sup></p>
               </div>
               <div class="col-md-3">
                 <div class="form-group">
                     <input type="radio" value="oui" name=""> Oui
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating" style="color:black;">Dans quelle fourchette se chiffrent vos revenus additionnels mensuels nets (en milliers)?</label>
                   <select class="form-control" name="">
                     <option value=""></option>
                      <option value="0-50">0-50</option>
                      <option value="50-200">50-200</option>
             ...
             <div class="row">
              <div class="col-md-3">
                <p style="color:black;">Pièce d'identité <sup style="color:red; font-weight:bold;">*</sup></p>
              </div>
              <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="row">
             <div class="col-md-3">
               <p style="color:black;">Contrat de travail <sup style="color:red; font-weight:bold;">*</sup></p>
             </div>
             <div class="col-md-3">
               <div class="form-group">
                   <input type="radio" value="oui" name="">
           ...
           <div class="row">
            <div class="col-md-3">
              <p style="color:black;">Bulletin de paie des six derniers mois <sup style="color:red; font-weight:bold;">*</sup></p>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                  <input type="radio" value="oui" name="">
          ...
          <div class="row">
           <div class="col-md-3">
             <p style="color:black;">Relevés bancaires des six derniers mois <sup style="color:red; font-weight:bold;">*</sup></p>
           </div>
           <div class="col-md-3">
             <div class="form-group">
                 <input type="radio" value="oui" name="">
