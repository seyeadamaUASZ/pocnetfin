  ...
  <div class="card" style="margin-top:20px;">
     ...
     <div class="card-body">
         ...
         <div class="table-responsive">
           ...
           <a href="soumissionpar.php" class="btn  btn-warning pull-right"><i class="material-icons">edit</i> Créer une nouvelle requête</a>
           <br>
           <table class="table table-striped" id="dataTable">
             ...
             <tbody>
              <tr>
                <td>15/09/2020</td>
                <td>Besoin immédiat de construction logement propre</td>
                <td style="text-align:center;" class="rep">En cours</td>
                <td>15/09/2020</td>
                <td>BHS</td>
                <td>Adama SEYE</td>
              </tr>
...
$('document').ready(function() {
 ...
 $("tr").each(function(i) {
     ...
     if ($(this).find('.rep').text() === 'En cours') {
