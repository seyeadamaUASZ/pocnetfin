    ...
    <div class="col-md-12">
        ...
        <div class="tab">
           ...
           <div class="professionnel">
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Nom et prénom de la personne introduisant la requête</label>
               ...
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Dénomination/Raison sociale</label>
                   <input type="text" class="form-control">
                 </div>
               </div>
               <!-- <div class="col-md-4">
               ...
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Nom et prénom du responsable</label>
                   <input type="text" class="form-control">
                 </div>
               </div>
             </div>
            ...
            <div class="particulier">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <label class="bmd-label-floating">Nom et prénom du bénéficiare</label>
                    <input type="text" class="form-control">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating">Localité</label>
                      <select class="form-control" name="">
                        <option value=""></option>
                        <option value="Dakar">Dakar</option>
                        <option value="Kaolack">Kaolack</option>
      ...
      <!--les questions sectionnées selon le profil particulier-->
           ...
           <div class="tab">
            <div class="card card-header" style="background-color:#6495ED;"><span style="color:black;font-weight:bold;">Informations sur l'activité</span></div>
             <div class="particulier">
              ...
              <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Quelle est la forme juridique de l’entité pour laquelle vous travaillez ? </label>
                   <select  id="mySelect" class="form-control" name="" onchange="mychoice()">
                     ...
                     <option value="societeR">Société à responsabilité limitée</option>
                     <option value="sc">Société en nom collectif</option>
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">De combien avez-vous besoin (en milliers) ?</label>
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Pourquoi avez-vous ce besoin?</label>
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Dans quelle fourchette se chiffre votre rémunération mensuelle nette (en milliers)?</label>
                   <select class="form-control" name="">
                     <option value=""></option>
                      <option value="0-50">0-50</option>
                      <option value="50-200">50-200</option>
             ...
             <div class="row">
               <div class="col-md-3">
                 <p> Avez-vous d’autres sources de revenus ?<sup style="color:red; font-weight:bold;">*</sup></p>
               </div>
               <div class="col-md-3">
                 <div class="form-group">
                     <input type="radio" value="oui" name=""> Oui
             ...
             <div class="row">
               <div class="col-md-4">
                 <div class="form-group">
                   <label class="bmd-label-floating">Dans quelle fourchette se chiffrent vos revenus additionnels mensuels nets (en milliers)?</label>
                   <select class="form-control" name="">
                     <option value=""></option>
                      <option value="0-50">0-50</option>
                      <option value="50-200">50-200</option>
             ...
             <div class="row">
              <div class="col-md-3">
                <p>Pièce d'identité <sup style="color:red; font-weight:bold;">*</sup></p>
              </div>
              <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="row">
             <div class="col-md-3">
               <p>Contrat de travail <sup style="color:red; font-weight:bold;">*</sup></p>
             </div>
             <div class="col-md-3">
               <div class="form-group">
                   <input type="radio" value="oui" name="">
           ...
           <div class="row">
            <div class="col-md-3">
              <p>Bulletin de paie des six derniers mois <sup style="color:red; font-weight:bold;">*</sup></p>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                  <input type="radio" value="oui" name="">
          ...
          <div class="row">
           <div class="col-md-3">
             <p>Relevés bancaires des six derniers mois <sup style="color:red; font-weight:bold;">*</sup></p>
           </div>
           <div class="col-md-3">
             <div class="form-group">
                 <input type="radio" value="oui" name="">
           ...
           <!-- <div class="col-md-3">
            ...
            <!-- <div class="card card-header" style="background-color:#6495ED;"><span style="color:black;font-weight:bold;">Information sur l'activité</span></div>-->
             ...
             <div class="col-md-4">
               ...
               <div class="col-md-4">
               <div class="form-group">
               <label class="bmd-label-floating">De combien avez-vous besoin (millions)?</label>
                 <select name="" id="" class="form-control">
                   <option value=""></option>
             ...
             <div class="row">
              ...
              <div class="col-md-4">
               <div class="form-group">
               <label class="bmd-label-floating">De quel ordre a été votre chiffre d’affaires l’an passé (en millions) ?</label>
                 <select name="" id="" class="form-control">
                   <option value=""></option>
                    <option value="0-50">0-50</option>
                    <option value="50-200">50-200</option>
             ...
             <div class="row">
               <div class="col-md-3">
                 <p> Etats financiers des trois derniers exercices</p>
               </div>
               <div class="col-md-4">
                 <div class="form-group">
                     <input type="radio" value="oui" name="">
