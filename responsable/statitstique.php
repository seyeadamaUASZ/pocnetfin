...
<tbody>
    <tr>
        <td>Nombre de requêtes soumises par des particuliers</td>
        <td><p class="card-title" style="font-weight:bold;">25</p></td>
    </tr>
    <tr>
        <td>Nombre de requêtes soumises par des professionnels</td>
        <td><p class="card-title" style="font-weight:bold;">50</p></td>
    </tr>

    <tr>
        <td>Nombre de requêtes acceptées</td>
        <td><p class="card-title" style="font-weight:bold;">30</p></td>
    </tr>


    <tr>
        <td>Nombre de requêtes rejetées</td>
        <td><p class="card-title" style="font-weight:bold;">20</p></td>
    </tr>

    <tr>
        <td>Nombre de requêtes rejetées pour dossier incomplets</td>
        <td><p class="card-title" style="font-weight:bold;">6</p></td>
    </tr>

    <tr>
        <td>Nombre de requêtes en cours</td>
...
<div class="col-md-12">
    <div class="card card-chart">
        ...
        <div class="card-body">
            <h4 class="card-title">Nombre requêtes soumises par mois</h4>
